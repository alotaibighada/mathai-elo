...
with tab1:
    ...
    st.markdown("**Tip:** Enter two numbers and select an operation to calculate.")
...
with tab2:
    ...
    st.markdown("**Tip:** Write equations like `x^2 - 4*x + 3 = 0`")
...
with tab3:
    ...
    st.markdown("**Tip:** Enter a function like `x^2 - 4*x + 3`")
